...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // ตรวจสอบค่าจากฟอร์มที่ส่งมา
        ...
        if ($stmt->execute()) {
            ...
            header("Location: ../../page/Instructor/course_list.php"); // เปลี่ยนไปที่หน้า edit_lesson.php และส่ง question_id
        } else {
            // หากเกิดข้อผิดพลาด
    ...
    header("Location: ../../page/Instructor/course_list.php"); // เปลี่ยนไปที่หน้า edit_lesson.php หากไม่ใช่ POST
}
exit;
?>
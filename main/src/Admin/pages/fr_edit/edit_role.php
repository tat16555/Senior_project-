...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $query = "SELECT permission_id, role, description, updated_at FROM Role WHERE permission_id = ?";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php if ($Role): ?>
                                    <form action="../../system/update/update_role.php" method="POST">
                                        <input type="hidden" name="permission_id" value="<?= htmlspecialchars($Role['permission_id']); ?>">

                                        <div class="form-group">
                                            <label for="Role">Role : <?= htmlspecialchars($Role['role']); ?></label>
                                        </div>

                                        <div class="form-group">
                                            <label for="description">description</label>
                                            <input type="text" id="description" name="description" class="form-control" value="<?= htmlspecialchars($Role['description']); ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">Save Changes</button>
                                            <a href="../tables/Role.php" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </form>
                                <?php else: ?>
                                    <p class="text-danger">Role not found.</p>
                                <?php endif; ?>
                            </div>
                            <!-- /.card-body -->
                        </div>

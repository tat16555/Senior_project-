              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $query = "SELECT course_id, course_code, course_name, course_description, user_id, view, created_at, updated_at FROM courses";
                      ...
                      // Main content
                  ?>
                  <?php while ($courses = $result->fetch_assoc()): ?>
                  <tr>
                      <td><?php echo $courses['course_code']; ?></td>
                      <td><?php echo $courses['course_name']; ?></td>
                      <td><?php echo $courses['course_description']; ?></td>
                      <td><?php echo $courses['user_id']; ?></td>
                      <td><?php echo $courses['view']; ?></td>
                      <td><?php echo $courses['created_at']; ?></td>
                      <td><?php echo $courses['updated_at']; ?></td>
                      <td>
                        <a href="../forms/edit_course.php?course_code=<?= $courses['course_code']; ?>" class="btn btn-warning">Edit</a>
                        <a href="lessons.php?course_code=<?= $courses['course_code']; ?>" class="btn btn-info">View list</a>
                        <a href="../../system/Delete/courses.php?course_code=<?= $courses['course_code']; ?>" class="btn btn-danger">Delete</a>
                      </td>                      
                  </tr>
                  <?php endwhile; ?>
                  </tbody>

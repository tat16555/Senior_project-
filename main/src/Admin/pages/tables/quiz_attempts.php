                      ...
                      <div class="card-body">
                          <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <td><?php echo $attempts['attempt_id']; ?></td>
                                      <td><?php echo $attempts['quiz_id']; ?></td>
                                      <td><?php echo $attempts['user_id']; ?></td>
                                      <td><?php echo $attempts['score']; ?></td>
                                      <td><?php echo $attempts['total_questions']; ?></td>
                                      <td><?php echo $attempts['correct_answers']; ?></td>
                                      <td><?php echo $attempts['attempt_date']; ?></td>
                                      <td><?php echo $attempts['status']; ?></td>
                                  </tr>
                                  <?php endwhile; ?>
                              </tbody>
                              <tfoot>

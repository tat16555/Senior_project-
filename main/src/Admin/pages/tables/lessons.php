    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>DataTables</h1>
            <a href="../forms/Add_Lesson.php?course_code=<?= $course_code; ?>" class="btn btn-info">Add Lessons</a>
            <a href="../management/quizzes.php?course_code=<?= $course_code; ?>" class="btn btn-info">view quizzes</a>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $query = "SELECT lesson_id, course_code, lesson_number, lesson_title, lesson_description, content, vdo_url, created_at, updated_at FROM lessons WHERE course_code = ?";
                  ...
                  <tr>
                      <td><?php echo $lessons['lesson_number']; ?></td>
                      <td><?php echo $lessons['lesson_title']; ?></td>
                      <td><?php echo $lessons['lesson_description']; ?></td>
                      <td><?php echo $lessons['created_at']; ?></td>
                      <td><?php echo $lessons['updated_at']; ?></td>
                      <td>
                        <a href="../forms/edit_lesson.php?lesson_id=<?= $lessons['lesson_id']; ?>&course_code=<?= $course_code; ?>" class="btn btn-warning">Edit</a>
                        <a href="../../system/Delete/lessons.php?lesson_id=<?= $lessons['lesson_id']; ?>" class="btn btn-danger">Delete</a>
                      </td>                      
                  </tr>
                  <?php endwhile; ?>
                  </tbody>
